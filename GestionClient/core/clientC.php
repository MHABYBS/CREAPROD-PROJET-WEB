<?php
   ...
   class ClientC 
   {
    ...
    {
      $sql="insert into client(nom,prenom,address,email,password,phone,hashed_pwd) values(:nom,:prenom,:address,:email,:password,:phone,:hashed_pwd)" ;
      ...
      try
      {
        ...
        $req->bindValue(':hashed_pwd',$client->getHashedPwd()) ;
        $req->execute() ;
        return true ;
    ...
    public function supprimerClient($id)
    {
      ...
      {
      $sql="UPDATE client SET id=:idd, nom=:nom,prenom=:prenom,email=:email,address=:address,password=:password,phone=:phone,hashed_pwd=:hashed_pwd WHERE id=:id";
      ...
      try{     
              ...
              $hashed_pwd=$client->getHashedPwd() ;
            $datas = array(':idd'=>$idd,':id'=>$id, ':nom'=>$nom, ':prenom'=>$prenom,':email'=>$email,':address'=>$address,':password'=>$password,':phone'=>$phone,':hashed_pwd'=>$hashed_pwd);
            ...
            $req->bindValue(':hashed_pwd',$hashed_pwd) ;         
