                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
                          ...
                          <ul style="display: none;">
                            <li><a href="listeComm.php">liste commandes</a></li>
                        ...
                        <li class="submenu">
                          <a href="#"><i class="fa fa-truck"></i></i> <span> Livraison </span> <span class="menu-arrow"></span></a>
                          <ul style="display: none;">
                            <li><a href="listeLivraison.php">liste Livraison</a></li>
                          </ul>
                        </li>
                        <li class="submenu">
